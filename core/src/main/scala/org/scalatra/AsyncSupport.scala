...
trait AsyncSupport extends ScalatraKernel {
   ...
   *
   */
  def asyncGet(routeMatchers: RouteMatcher*)(block: => Any): Route = addRoute(Get, routeMatchers, futures.future { block })

  /**
   * @see asyncGet
   */
  def asyncPost(routeMatchers: RouteMatcher*)(block: => Any): Route = addRoute(Post, routeMatchers, futures.future { block })

  /**
   * @see asyncGet
   */
  def asyncPut(routeMatchers: RouteMatcher*)(block: => Any): Route = addRoute(Put, routeMatchers, futures.future { block })

  /**
   * @see asyncGet
   */
  def asyncDelete(routeMatchers: RouteMatcher*)(block: => Any): Route = addRoute(Delete, routeMatchers, futures.future { block })

  /**
   * @see asyncGet
   */
  def asyncOptions(routeMatchers: RouteMatcher*)(block: => Any): Route = addRoute(Options, routeMatchers, futures.future { block })

  /**
   * @see asyncGet
   */
  def asyncPatch(routeMatchers: RouteMatcher*)(block: => Any): Route = addRoute(Patch, routeMatchers, futures.future { block })
}
